...
<h3>sandom salt를 사용하는 경우는 암호화된 결과 값이 매번 바뀌기 때문에 StringFixedSaltGenerator를 사용 하여 테스트 하기 위해 암호화된 결과 값을 고정해서 사용하였음</h3>
<br><br><br><br><br>
...
<h3>입력받은 아이디 패스워드를 AES256 암호화 -> 로그인 성공 시 암호화된 결과값을 화면에 표시 </h3>
<img width ="100%" src="https://user-images.githubusercontent.com/68227318/102083138-6fe01c80-3e56-11eb-891d-39b7a954cc5e.jpg">

<br><br><br>
<h3>AES-256으로 암호화된 아이디 패스워드 값을 복호화(패스워드는 SHA-256으로 한번 더 암호화 진행)-> 암호화된 로그인 정보값을 복호화 콘솔로 확인</h3>
